# =====Destiny======
# train, test(after loading all text files, and save as numpy array)
# don't need to read original files every time, for testing simply
...
def main(args):
    ...
    # dataset.split2save() # first time, uncomment
